...
export const ColorPicker = ({
  ...
  return (
    ...
    >
      ...
      <ColorButton color={{ r: 255, g: 127, b: 255 }} onClick={onChange} />
      <ColorButton color={{ r: 39, g: 142, b: 237 }} onClick={onChange} />
      <ColorButton color={{ r: 4, g: 106, b: 56 }} onClick={onChange} />
      <ColorButton color={{ r: 252, g: 103, b: 31 }} onClick={onChange} />
